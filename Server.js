...
var dashboard_data_rest_api  =  require("./REST_API/dashboard_data_rest_api.js");
...
REST.prototype.configureExpress = function(connection) {
      ...
      var dashboard_data_rest_router = new dashboard_data_rest_api(router, connection, md5);
      self.startServer();
}
